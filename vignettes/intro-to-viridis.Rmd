...
- Dave Green's [`cubehelix'](https://www.mrao.cam.ac.uk/~dag/CUBEHELIX/) colour scheme (implemented in the [rje](https://cran.r-project.org/web/packages/rje/index.html) package).
...
img(rev(cubeHelix(n_col)), "cubeHelix")
img(rev(viridis(n_col)), "viridis")
img(rev(magma(n_col)), "magma")
```
...
img(dichromat(rev(cubeHelix(n_col)), "deutan"), "cubeHelix")
...
img(dichromat(rev(cubeHelix(n_col)), "protan"), "cubeHelix")
...
img(dichromat(rev(cubeHelix(n_col)), "tritan"), "cubeHelix")
...
img(desaturate(rev(cubeHelix(n_col))), "cubeHelix")
