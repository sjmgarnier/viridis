...
The [**viridis**](https://cran.r-project.org/web/packages/viridis/) package
...
These color scales are designed to:

- Be **Perceptually uniform**, meaning that values close to each other have similar-appearing colors and values far away from each other have more different-appearing colors, consistently across the range of values,
- Cover a **wide perceptual ranges**, using as much of the perceptual space as possible
so as to make differences easy to see,
- Appear **robust to colorblindness**, so that the above properties hold true for people with
most form of colorblindness, as well as in grey scale printing, and
- Be **pretty**, oh so pretty

If you are interested in the science behind creating these color scales, van
...
large *perceptual range*. It makes full use of the available color space.

Now, let's compare these as they might appear under various forms of colorblindness,
which can be simulated using the **[dichromat](https://cran.rstudio.com/web/packages/dichromat/index.html)** package:
...
between low and high values.  The "viridis" and "magma" scales do better by
these measures.
...
[![](https://pbs.twimg.com/media/CQWw9EgWsAAoUi0.png)](https://twitter.com/jalapic/status/650120284901634048/photo/1)

[Jeff Hollister](https://twitter.com/jhollist) uses the viridis as a discrete categorical scale ([Code](https://github.com/USEPA/LakeTrophicModelling/blob/master/vignettes/manuscript.Rmd#cbpalette---c0072b2999999f0e442d55e00)):


[![](https://github.com/USEPA/LakeTrophicModelling/blob/master/vignettes/manuscript_files/figure-latex/gis_probability_map-1.jpeg?raw=TRUE)](https://github.com/USEPA/LakeTrophicModelling/blob/master/vignettes/manuscript_files/figure-latex/gis_probability_map-1.jpeg)
...
[![](https://pbs.twimg.com/media/CQWTy7wWcAAa-gu.jpg)](https://twitter.com/lifedispersing/status/650088228016508928/photo/1)
